...
import { saveEndData } from "./saveChoiceData.js";
...
import { jsPsych } from "./constructStudy1_first.js";
...
var choice_items_2 = [11,  21,  25,  28,  29, 31]
// ,  35,  37,  44,  45,  47,  53,  55,  56,  59,  61,  67,  73,  75,  76,  77,  78,  83,  84,  97, 100, 102, 108, 110, 115, 120, 125];
...
if (debugging == false) {
    nTrialsChoice = choice_items_2.length;
...
var preamble_choice_2 = {
    ...
    stimulus: (`
               ...
               你认为导致该事件发生最主要的原因是什么。</i></b>你需要从给定的 4 个选项中选择其中一项。
               </p>
               <p>
               ...
               <p>
               和第一次测验一样，本次测验一共包括 32 个事件，在测验进行到一半时，我们会提示您，您可以自行休息。
               </p>
               <p>
               当你准备好了，请点击 <b>继续</b> 按钮！
               </p>
               `)
};
